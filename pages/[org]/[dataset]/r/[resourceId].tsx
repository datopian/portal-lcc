            ...
            <div className="py-2 custom-container ">
              <div className="flex flex-col  md:flex-row gap-4 md:items-center py-2">
                <span className="font-medium text-gray-500 inline">
                  ...
                  Created: {resource.created && getTimeAgo(resource.created)}
                </span>
                <span className="font-medium text-gray-500 inline">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className=" py-4">
                <Link
                  href={resource.url}
                  className="bg-accent h-auto py-2 px-4 text-sm text-black rounded-xl font-roboto font-bold hover:bg-darkaccent hover:text-white duration-150 flex items-center gap-1 w-fit"
                >
                  Download
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
